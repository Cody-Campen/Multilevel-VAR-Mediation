...
simulate_data = function(nsubs = 100,
                         ...
                         mediator_effect_matrix = matrix(c(1,   # M_1 intercept -> Y
                                                           ...
                                                           4,   # M_1 -> M_2 crossregression -> Y 
                                                           5,   # M_2 -> M_1 crossregression -> Y
                                                           6,   # M_2 autoregression -> Y
                                                           7,   # M_1 log of process noise sd -> Y
                                                           8,   # M_2 log of process noise sd -> Y
                                                           9),  # fisher z transformed M_1 M_2 correlation -> Y
                                                       nrow = 9, ncol = 1, byrow = T),
                         direct_effect = matrix(c(10,  # Y intercept
                                                  20,  # X1 -> Y
                                                  30), # X2 -> Y
